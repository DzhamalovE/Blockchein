...
transactions1 = [Transaction("Alice", "Bob", 10, 0.1, utxo_model), Transaction("Bob", "Charlie", 5, 0.05, utxo_model)]
transactions2 = [Transaction("Charlie", "Dave", 15, 0.2, utxo_model)]
